...
"^":"u8;Y8"},
JI:{
"^":"yU;Ae,iE@,SJ?,Y8,dB,o7,ls,Lj,Xl,lz,Ri",
...
for(z=this.eM,y=z.gUQ(z),x=y.l6,y=H.VM(new H.MH(null,x.gA(x),y.T6),[H.Kp(y,0),H.Kp(y,1)]);y.G();)y.lo.Gv()
if(z.X5>0){z.lX=null
z.H9=null
z.OB=null
z.OX=null
...
"^":"Tp:10;",
call$1:function(a){var z=J.x(a)
return typeof a==="object"&&a!==null&&!!z.$iscv}}}],["","file:///C:/Users/Axel/WebstormProjects/Color/web/main.dart",,F,{
"^":"",
Iq:[function(){var z=new O.LJ(document.querySelector("#loader"))
$.G4=z
z.wE(0)},"call$0","eE",0,0,0]},1],["manager_color","file:///C:/Users/Axel/WebstormProjects/Color/web/Manager_Color.dart",,V,{
"^":"",
oe:{
"^":"a;MY",
hN:function(a){var z,y,x,w,v
z=H.VM([],[U.uH])
for(y=this.MY,x=0;x<a;++x){do{w=C.pr.j1(y.length)
if(w<0||w>=y.length)return H.e(y,w)
v=y[w]}while(H.Ri(z,v,0,z.length)!==-1)
z.push(v)}return z},
Bd:function(){var z,y
z=this.MY
y=new U.uH(null,null,null)
y.oc="rouge"
y.fd="#e74c3c"
y.Q2="#EB8D84"
z.push(y)
...
y.Q2="#B699C2"
z.push(y)},
static:{"^":"mg"}}}],["manager_scene","file:///C:/Users/Axel/WebstormProjects/Color/web/Manager_Scene.dart",,B,{
"^":"",
e1:function(){for(var z=$.wY(),z=new H.a7(z,z.length,0,null);z.G();)z.lo.Gv()}}],["sceneColor","file:///C:/Users/Axel/WebstormProjects/Color/web/Scene_Color.dart",,S,{
"^":"",
eV:{
"^":"n5;jb,IN,ZB,Sf,Aa,Rk,V3,zo,Jf,aj",
wE:function(a){var z,y
for(z=this.Aa,z=z.gA(z);z.G();){y=J.Vg(z.lo)
$.wY().push(y.yI(new S.hn(this)))}z=H.VM(new W.RO(window,C.Z4.Ph,!1),[null])
$.wY().push(z.yI(new S.Mk(this)))
this.mo()},
Bf:function(){return},
Sx:function(){var z,y,x,w
z=$.EF().hN(3)
this.Lm(z)
y=z.length
...
J.FI(w.style,y.fd)
J.pP(w).h(0,"bigger")
J.pP(this.ZB).h(0,"upper")
if(2>=z.length)return H.e(z,2)
w=z[2].Q2
J.LX(this.jb.style,w)
this.aj=P.rT(P.k5(0,0,0,this.zo,0,0),new S.MV(this))},
Lm:function(a){var z,y,x,w,v
z=C.pr.j1(a.length)
y=this.Aa.Sn
if(z<0||z>=y.length)return H.e(y,z)
this.Jf=y[z]
for(x=0;x<a.length;++x){w=y.length
v=C.jn.Y(x+z,w)
...
y=this.V3
if(z)this.V3=y+1
else{z=new S.cn(document.querySelector("#score"),document.querySelector("#shadow"),document.querySelector("#num"),document.querySelector("#restart"),null)
z.yG=y
$.G4.Bf()
B.e1()
$.G4=z
z.wE(0)
return}this.mo()},
mo:function(){J.pP(this.IN).Rz(0,"bigger")
J.pP(this.ZB).Rz(0,"upper")
P.rT(P.k5(0,0,0,16,0,0),new S.vJ(this))}},
hn:{
"^":"Tp:10;a",
call$1:function(a){return this.a.qY(J.l2(a))}},
Mk:{
"^":"Tp:19;b",
call$1:function(a){var z=this.b
switch(J.Zm(a)){case 37:z.qY(J.OG(z.Sf).t(0,0))
break
case 40:z.qY(J.OG(z.Sf).t(0,1))
break
case 39:z.qY(J.OG(z.Sf).t(0,2))
break
default:}return}},
MV:{
"^":"Tp:8;a",
call$0:function(){return this.a.qY(null)}},
vJ:{
"^":"Tp:8;a",
call$0:function(){return this.a.Sx()}}}],["scene_base","file:///C:/Users/Axel/WebstormProjects/Color/web/Scene_Base.dart",,Q,{
"^":"",
n5:{
"^":"a;"}}],["scene_score","file:///C:/Users/Axel/WebstormProjects/Color/web/Scene_Score.dart",,S,{
"^":"",
cn:{
"^":"n5;V3,ot,FK,Zx,yG",
wE:function(a){var z
this.FK.textContent=C.jn.bu(this.yG)
J.pP(this.ot).h(0,"visible")
J.pP(this.V3).h(0,"open")
z=J.Vg(this.Zx)
$.wY().push(z.yI(new S.r4(this)))},
Bf:function(){J.pP(this.ot).Rz(0,"visible")
J.pP(this.V3).Rz(0,"open")}},
r4:{
"^":"Tp:10;a",
call$1:function(a){var z=new S.eV(document.querySelector("#content"),document.querySelector("#word"),document.querySelector("#chrono"),document.querySelector("#choices"),W.vD(document.querySelectorAll(".choice"),null),H.VM([],[P.MO]),0,1010,null,null)
$.G4.Bf()
B.e1()
$.G4=z
z.wE(0)
return}}}],["scene_title","file:///C:/Users/Axel/WebstormProjects/Color/web/Scene_Title.dart",,O,{
"^":"",
LJ:{
"^":"n5;yL",
wE:function(a){var z,y
z=this.yL
y=J.Vg(z)
$.wY().push(y.yI(new O.NW(this)))
z=J.Vg(z.querySelector("a"))
$.wY().push(z.yI(new O.uQ(this)))},
Bf:function(){return}},
NW:{
"^":"Tp:10;a",
call$1:function(a){var z
J.pP(this.a.yL).h(0,"loaded")
z=new S.eV(document.querySelector("#content"),document.querySelector("#word"),document.querySelector("#chrono"),document.querySelector("#choices"),W.vD(document.querySelectorAll(".choice"),null),H.VM([],[P.MO]),0,1010,null,null)
$.G4.Bf()
B.e1()
$.G4=z
z.wE(0)
...
uQ:{
"^":"Tp:10;b",
call$1:function(a){J.tW(a)
return}}}],["tools","file:///C:/Users/Axel/WebstormProjects/Color/web/Color.dart",,U,{
"^":"",
uH:{
"^":"a;oc,fd,Q2"}}],])
...
I.$lazy($,"_singleton","mg","EF",function(){var z=new V.oe(H.VM([],[U.uH]))
z.Bd()
return z})
I.$lazy($,"_events","tA","wY",function(){return H.VM([],[P.MO])})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"uu",void:true,args:[P.a],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"c0",args:[W.HL]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
Gm.prototype=$desc
function JI(Ae,iE,SJ,Y8,dB,o7,ls,Lj,Xl,lz,Ri){this.Ae=Ae
this.iE=iE
this.SJ=SJ
this.Y8=Y8
this.dB=dB
...
if($desc instanceof Array)$desc=$desc[1]
nP.prototype=$desc
function KA(dB,o7,ls,Lj,Xl,lz,Ri){this.dB=dB
this.o7=o7
this.ls=ls
this.Lj=Lj
this.Xl=Xl
...
if($desc instanceof Array)$desc=$desc[1]
Zf.prototype=$desc
function oe(MY){this.MY=MY}oe.builtin$cls="oe"
if(!"name" in oe)oe.name="oe"
$desc=$collectedClasses.oe
if($desc instanceof Array)$desc=$desc[1]
oe.prototype=$desc
function eV(jb,IN,ZB,Sf,Aa,Rk,V3,zo,Jf,aj){this.jb=jb
this.IN=IN
this.ZB=ZB
this.Sf=Sf
this.Aa=Aa
...
if($desc instanceof Array)$desc=$desc[1]
hn.prototype=$desc
function Mk(b){this.b=b}Mk.builtin$cls="Mk"
...
if($desc instanceof Array)$desc=$desc[1]
n5.prototype=$desc
function cn(V3,ot,FK,Zx,yG){this.V3=V3
this.ot=ot
this.FK=FK
this.Zx=Zx
this.yG=yG}cn.builtin$cls="cn"
...
if($desc instanceof Array)$desc=$desc[1]
r4.prototype=$desc
function LJ(yL){this.yL=yL}LJ.builtin$cls="LJ"
if(!"name" in LJ)LJ.name="LJ"
$desc=$collectedClasses.LJ
if($desc instanceof Array)$desc=$desc[1]
LJ.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
NW.prototype=$desc
function uQ(b){this.b=b}uQ.builtin$cls="uQ"
if(!"name" in uQ)uQ.name="uQ"
$desc=$collectedClasses.uQ
if($desc instanceof Array)$desc=$desc[1]
uQ.prototype=$desc
function uH(oc,fd,Q2){this.oc=oc
this.fd=fd
this.Q2=Q2}uH.builtin$cls="uH"
if(!"name" in uH)uH.name="uH"
$desc=$collectedClasses.uH
if($desc instanceof Array)$desc=$desc[1]
uH.prototype=$desc
